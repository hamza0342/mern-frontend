...
import {singleProject, deleteProject, updateProject, updatedProject} from '../Client/clientapi'
    ...
    const renderProjects = (project) =>{
        ...
        return (
            <div className="card-body">
                ...
                <Link to={`/gc/dashboard`} className="btn btn-raised btn-info btn-sm" style={styles.backButton}>Back to Home</Link>
